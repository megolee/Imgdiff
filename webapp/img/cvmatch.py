#!/usr/bin/env python
# -*- coding: utf-8 -*-
# /Users/megolees/Downloads/Match1.png
# Created on 2019-01-07
import cv2
import numpy as np

# 读取名称为 p20.png 的图片，并转成黑白
img = cv2.imread("/Users/megolees/Downloads/Match1.png",1)
gray = cv2.imread("/Users/megolees/Downloads/Match1.png",0)

# 读取需要检测的芯片图片（黑白）
img_template = cv2.imread("/Users/megolees/Downloads/Match2.png",0)
# 得到芯片图片的高和宽
